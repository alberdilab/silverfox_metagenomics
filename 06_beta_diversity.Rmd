...
```{r dispersion_check, comment="", message=FALSE, warning=FALSE}
...
adonis2(beta_q0n$S ~ fox_behaviour+gut_location,
        ...
        tt()
```
```{r pairwise_richness, comment="", message=FALSE, warning=FALSE}
...
```{r dispersion_neutral, comment="", message=FALSE, warning=FALSE}
#Neutral diversity
...
```
```{r pairwise_neutral_gutlocation, comment="", message=FALSE, warning=FALSE}
pairwise.adonis(beta_q1n$S, sample_metadata$gut_location, perm = 999)
```

#### Phylogenetic

```{r dispersion_phylo, comment="", message=FALSE, warning=FALSE}
...
```{r pairwise_phylogenetic, comment="", message=FALSE, warning=FALSE}
...
#### Functional
```{r dispersion_func, comment="", message=FALSE, warning=FALSE}
